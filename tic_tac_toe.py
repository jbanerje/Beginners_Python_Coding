...
def chk_winning_cond(player_num,comb):
    ...
    #for Winning combination in 3 chances
    if (count_pos == 3):
        print("In Count 3 :", comb)
        if (add_pos == 15):
            print("sum = 15")
            ...
            if ((track_comb_2 == 'true') or (track_comb_5 == 'true') or (track_comb_7 == 'true') or (track_comb_8 == 'true')):
                game_status = "Win"
            else:
                game_status = "Game_on"
                
        elif((add_pos == 6) or (add_pos == 12) or (add_pos == 18) or (add_pos == 24)):
            if (add_pos == 6):
                print("sum = 6")
                winning_comb = win_comb_1
                
            if (add_pos == 12):
                print("sum = 12")
                winning_comb = win_comb_4
                
            if (add_pos == 18):
                print("sum = 18")
                winning_comb = win_comb_6
                
            if (add_pos == 24):
                print("sum = 24")
                winning_comb = win_comb_3

            track_comb = comp(comb, winning_comb)

            print("track_comb-",track_comb)
    ...
    #for Winning combination in 3 chances       
            ...
            temp_comb_1 = comb[0:3]
            temp_comb_2 = comb[1:4]
            ...
            if ( (sum_temp_comb_1 == 15) or (sum_temp_comb_2 == 15) or (sum_temp_comb_3 == 15) or (sum_temp_comb_4 == 15)):
                ...
                if ((track_comb_1a == 'true') or (track_comb_1b == 'true') or (track_comb_1c == 'true') or (track_comb_1d == 'true') or
                    (track_comb_2a == 'true') or (track_comb_2b == 'true') or (track_comb_2c == 'true') or (track_comb_2d == 'true') or
                    (track_comb_3a == 'true') or (track_comb_3b == 'true') or (track_comb_3c == 'true') or (track_comb_3d == 'true') or
                    (track_comb_4a == 'true') or (track_comb_4b == 'true') or (track_comb_4c == 'true') or (track_comb_4d == 'true')):
                ...
                track_comb = comp(temp_comb_1, winning_comb) #function call for winning combination
